...
public class PanelBotones extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        botonAcelerarAutomatico = new javax.swing.JButton();
        botonMantenerAutomatico = new javax.swing.JToggleButton();
        ...
        panelSuperior.add(etiquetaVelocidadCrucero, java.awt.BorderLayout.PAGE_END);
        ...
        botonAcelerarAutomatico.setText("ACELERAR SCACV");
        botonAcelerarAutomatico.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                botonAcelerarAutomaticoActionPerformed(evt);
            }
        });
        panelInferior.add(botonAcelerarAutomatico);

        botonMantenerAutomatico.setText("MANTENER SCACV");
        panelInferior.add(botonMantenerAutomatico);
    ...
    private void botonAcelerarAutomaticoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonAcelerarAutomaticoActionPerformed
        if (botonAcelerar.isSelected()){
            if (botonAcelerarAutomatico.isSelected()) {
                botonAcelerar.setForeground(Color.black);
                botonAcelerar.setText("ACELERAR");
                botonAcelerar.setSelected(false); 
            }
            else {
                botonAcelerarAutomatico.setSelected(false);
            }
        }
    }//GEN-LAST:event_botonAcelerarAutomaticoActionPerformed
    ...
    private javax.swing.JButton botonAcelerarAutomatico;
    private javax.swing.JToggleButton botonEncender;
    private javax.swing.JToggleButton botonFrenar;
    private javax.swing.JToggleButton botonMantenerAutomatico;
